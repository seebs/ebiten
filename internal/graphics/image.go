...
func (i *Image) DrawImage(src *Image, vertices []float32, indices []uint16, clr *affine.ColorM, tints []color.RGBA, mode opengl.CompositeMode, filter Filter) {
	theCommandQueue.EnqueueDrawImageCommand(i, src, vertices, indices, clr, tints, mode, filter)
}
